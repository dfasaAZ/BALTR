...
public partial class Table3 : System.Web.UI.Page
{
    ...
    const string Table = "[Прокат]";
    const string Column = "[Клиент]";
    protected void Filter_TextChanged(object sender, EventArgs e)
    {

        string filter = Filter.SelectedValue;
        if (filter != "")
        {//Если не пустой, фильтруем
            
            SqlDataSource1.SelectCommand = "SELECT * FROM " + Table + " WHERE " + Column + " =  @Filter ";
    ...
    protected void btnAddNewRow_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.InsertCommand = "INSERT INTO " + Table + " ([Код],[Автомобиль],[Клиент]) VALUES (" + max + ",1,1)";
        try
        {
    ...
    protected void WordExport_Click(object sender, EventArgs e)
    {
        ...
        string tableStyle = "Таблица простая 2";

        object oMissing = System.Reflection.Missing.Value;
        object oEndOfDoc = "\\endofdoc"; 


        SqlDataSource sqlDS = this.SqlDataSource4;
