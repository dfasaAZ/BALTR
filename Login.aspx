...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringCar %>" ProviderName="<%$ ConnectionStrings:ConnectionStringCar.ProviderName %>" SelectCommand="SELECT * FROM [SignIn]"></asp:SqlDataSource>
